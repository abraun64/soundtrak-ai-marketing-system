...
- **Lenses swept (deeper audit — may stay collapsed)** — the named creative lenses CD ran (format · emotional-register · protagonist · mechanic · cultural-borrow · channel-native · contrarian · tenant-specific) + the Digital Twin frameworks applied (principles 1–24 / Core Marketing Capabilities Framework / case studies). This is the methodology trail; it can sit in a collapsed `<details>` below the kill register.
