...
- Use the Marks in any way that suggests endorsement, sponsorship, affiliation with, or origin from Soundtrak Consulting.
- Keep the Soundtrak branding on a **fork or modified version** — if you change the software, you must remove Soundtrak branding and use your **own** name and marks for the result.

Permission requests and questions: **soundtrakconsulting.com**.
